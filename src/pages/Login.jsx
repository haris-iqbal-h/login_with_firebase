...
import img2 from './../assets/images/login.gif'
    ...
    <>
      {/* <!-- component --> */}
        <div className="flex items-center justify-center h-screen">
          {/* <!-- Login Container --> */}
            <div className="min-w-fit flex-col border bg-white px-6 py-14 shadow-xl rounded-[4px] ">
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className="mt-5 flex justify-center gap-3    ">
                <img className="h-7 grayscale cursor-pointer hover:grayscale-0 scale-105 duration-300" alt='' 
                ...
                <Link className="bg-gray-400 h-7 w-7 rounded-3xl text-center grayscale cursor-pointer hover:grayscale-0 scale-105 duration-300 " 
                to="">...</Link>
            </div>
            <div className="mt-5 flex text-center text-sm text-gray-400">
                <p>
                This site is protected by reCAPTCHA and the Google <br />
                <Link className="underline" to="">Privacy Policy</Link>  and <Link className="underline" to="">Terms of Service</Link>  apply.
                </p>
            </div>
            </div>
        </div>
